...
from env import parse_obs, build_input


def main() -> None:
    parser = argparse.ArgumentParser()
    parser.add_argument("--model",  default="checkpoints/latest",      help="Pfad zum SB3-Modell")
    ...
    print(f"Zum Zuschauen Client öffnen → Server '{args.server}' → Room '{args.room}' → Zuschauen\n")
